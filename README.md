...
not a lot that I’ve built can be shared outside company walls, but I did enjoy writing this [set up script for my dev machine](https://github.com/MoRevolution/dev) in nushell.
